...
const Footer = () => {
    return (
        ...
        <div className={"flex flex-col lg:flex-row items-center justify-between w-full h-[2/10] shadow-lg border  border-gray-200   p-5"}>
            ...
            <div className="mx-6">
                ...
                <div className="flex items-center justify-center gap-1 ">
                    <FaXTwitter />
                    <h4 className="text-blue-500 cursor-pointer">Twitter</h4>
                </div>
                <div className="flex items-center justify-center gap-1 ">
